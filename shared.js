...
// exits＝一般交流道出口接的一般道路（台X、縣道…）。路網資料裡沒有這項，這裡的值是示意，要另外建資料
const SCENARIOS = {
  t64: {
    key: 't64', label: '台64 八里段', sub: '西向到八里二是終點，左接 61 南下、右接 61 北上', road: '100640',
  ...
  n3: {
    ...
    nodes: [
      ...
      { name: '新台五路', km: 12, exits: ['台5'] },
      { name: '南港', km: 14, exits: ['台5', '縣106', '縣106乙'] },
